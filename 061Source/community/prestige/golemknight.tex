...
It possesses a Natural armor bonus of +0 but an armor bonus equal to its hit dice and an Enhancement bonus to Strength and armor equal to the class level of the Golem Knight. It is completely loyal to the Golem Knight, but when not being ridden, it stands motionless, unable to act.
