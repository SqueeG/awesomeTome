...
\itemability{Special:}{Must have \texit{started} a fight with an Evil Outsider. Angelic Knights need only meet one of the two skill requirements (but still must be Good and have the Blitz feat).}
\end{list}\vspace*{8pt}
