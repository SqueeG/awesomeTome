...
The time required to don armor depends on its type, see the table below.
...
\multicolumn{4}{p{\textwidth}}{\textsuperscript{2} The wearer must have help to don this armor. Without help, it can be donned only hastily.}\\
\end{tabu}}