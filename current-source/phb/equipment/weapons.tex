...
\noindent\footnotetext[1]{The size and damage for this weapon indicates the size of the creature using it,  instead of the actual size of the weapon. These weapons are always considered light weapons.}
}
