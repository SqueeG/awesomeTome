...
\begin{tabular}{| L{.75in} | C{.45in} |C{.6in} |C{.5in} | C{.35in} | C{.45in} | C{.45in} | C{.45in} | C{.5in} | C{.5in} |} \hline
 \multicolumn{1}{|c|}{\textbf{Weapon}} &\textbf{Critical} &\textbf{Type} &\textbf{Range} &\textbf{Fine} &\textbf{Dimin.} &\textbf{Tiny} &\textbf{Small} &\textbf{Medium} &\textbf{Large} \\ \hline
 ...
 \multicolumn{10}{|L{5in}|}{\textsuperscript{1} The size and damage for this weapon indicates the size of the creature using it, instead of the actual size of the weapon. These weapons are always considered light weapons.} \\ \hline
\end{tabular}
\end{footnotesize}
\end{table}
