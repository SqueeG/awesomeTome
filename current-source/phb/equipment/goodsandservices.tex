...
\multicolumn{2}{p{\textwidth}}{\textsuperscript{1} See spell description for additional costs. If the additional costs put the spell's total cost above 3,000 gp, that spell is not generally available.}\\ \hline
\end{tabu}
\end{table}
