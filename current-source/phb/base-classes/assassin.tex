\ClassEntry{Assassin (12pt)} \label{class:assassin}
\vspace{-8pt}
...
\rowcolor{gray!50} Level &Base Attack &Fort. &Ref. &Will &Special& Death Attack\\
...
\rowcolor{gray!50} & \multicolumn{7}{c}{Assassin Spells Per Day}  & &   &\multicolumn{7}{c}{Assassin Spells Known}\\
...
\end{tabular}
\end{floatingfigure}
\fontsize{12pt}{\originallineskip}\selectfont
...
\ClassEntry{Assassin (10pt)} \label{class:assassin}
\vspace{-8pt}
\quot{``I kill people. Individually, you are a person. Collectively, I think you count as people.''}
...
\ClassEntry{Assassin (8pt)} \label{class:assassin}
\vspace{-8pt}
\quot{``I kill people. Individually, you are a person. Collectively, I think you count as people.''}
