...
\header\multicolumn{6}{c}{Naming your Soulmelds}\\
\header\multicolumn{6}{c}{Roll a d10 for each column, combine as desired!} \\
\cellcolor{headercolor}1&Running&\cellcolor{headercolor}1&Ox&\cellcolor{headercolor}1&Fist\\
\cellcolor{headercolor}2&Hungry&\cellcolor{headercolor}2&Tiger&\cellcolor{headercolor}2&Stance\\
\cellcolor{headercolor}3&Angry&\cellcolor{headercolor}3&Dragon&\cellcolor{headercolor}3&Spinning Kick\\
\cellcolor{headercolor}4&Naked&\cellcolor{headercolor}4&Crane&\cellcolor{headercolor}4&Attack\\
\cellcolor{headercolor}5&Drunken&\cellcolor{headercolor}5&Monkey&\cellcolor{headercolor}5&Technique\\
\cellcolor{headercolor}6&Fortunate&\cellcolor{headercolor}6&Turtle&\cellcolor{headercolor}6&Style\\
\cellcolor{headercolor}7&Lazy&\cellcolor{headercolor}7&Manticore&\cellcolor{headercolor}7&Dance\\
\cellcolor{headercolor}8&Swift&\cellcolor{headercolor}8&Serpent&\cellcolor{headercolor}8&Movement\\
\cellcolor{headercolor}9&Powerful&\cellcolor{headercolor}9&Hummingbird&\cellcolor{headercolor}9&Touch\\
\cellcolor{headercolor}10&Enlightened&\cellcolor{headercolor}10&Demon&\cellcolor{headercolor}10&Fu\\
