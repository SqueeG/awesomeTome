...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\titleformat{\section}[block]{\Large\bfseries\selectfont}{}{0ex}{}[\vspace{-0ex}]
\titleformat{\subsection}[block]{\Large\bfseries\selectfont}{}{0ex}{}[\vspace{-0ex}]
\titleformat{\subsubsection}[block]{\Large\bfseries\selectfont}{}{0ex}{}[\vspace{-0ex}]
...
\newcommand{\raceentry}[2]{\newpage\renewcommand{\race}{#1}\section{#1} \label{race:#1}\textit{#2}}
