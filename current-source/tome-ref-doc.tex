...
\newcommand{\option}[2]{
  \renewmdenv[hidealllines=true,backgroundcolor=colorone]{optionbox}
   \begin{optionbox}\noindent\textbf{#1}\end{optionbox}
  \renewmdenv[hidealllines=true,backgroundcolor=colortwo]{optionbox}
   \begin{optionbox}#2\end{optionbox}
}

\newenvironment{optional}[2]
{
\colorlet{colorone}{gray!30}
\colorlet{colortwo}{gray!15}

 \ifx#1\isempty\else\renewmdenv[hidealllines=true,backgroundcolor=headercolor]{optionbox}
  \begin{optionbox}\begin{large}\noindent\textbf{#1}\end{large}\end{optionbox}\fi
  \ifx#2\isempty\else\renewmdenv[hidealllines=true,backgroundcolor=colortwo]{optionbox}\fi
  \begin{optionbox}#2\end{optionbox}
}{
\colorlet{colorone}{white}
\colorlet{colortwo}{gray!15}
