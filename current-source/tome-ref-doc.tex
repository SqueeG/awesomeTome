...
\newcommand{\raceentry}[2]{\newpage\renewcommand{\race}{#1}\subsection{#1} \label{race:#1}\textit{#2}}
...
\header\multicolumn{4}{l}{\textbf{\race ~Starting Age}}\\
\textbf{Adulthood:}&\textbf{Simple:}&\textbf{Moderate:}&\textbf{Complex:}\\
#1 Years&#2&#3&#4\\
\end{tabularx}
}

\newcommand{\MALE}{placeholder}
\newcommand{\male}[4]{\renewcommand{\MALE}{Male&#1&#2&#3&#4\\}}
\newcommand{\FEMALE}{placeholder}
\newcommand{\female}[4]{\renewcommand{\FEMALE}{Female&#1&#2&#3&#4\\}}

\newcommand{\heightweighttable}{
\rowcolors{1}{colorone}{colortwo}
\begin{tabularx}{\columnwidth}{XXXXX}
\header\multicolumn{5}{l}{\textbf{\race ~Height and Weight}}\\
...
\centering
\rowcolors{1}{colorone}{colortwo}
\begin{longtabu} to \textwidth {p{.275in} l p{0.275in} p{0.275in} p{0.275in} X l l l l}
...
foo
\input{phb/base-classes/assassin}
\input{phb/base-classes/barbarian}
%\input{Bard}
\input{phb/base-classes/cleric}
%\input{Druid}
\input{phb/base-classes/fighter}
\input{phb/base-classes/knight}
\input{phb/base-classes/monk}
%\input{Paladin}
%\input{Ranger}
%\input{Rogue}
%\input{Samurai}
%\input{Sorcerer}
\input{phb/base-classes/templar}
\input{phb/base-classes/wizard}
