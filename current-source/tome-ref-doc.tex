...
\newcommand{\classtableautohead}[1]{
\begin{table}[htb]
\centering
\begin{small}
\rowcolors{1}{colorone}{colortwo}
...
%A command that sets up the class feature table.
...
\newcommand{\classtableautofoot}{
\end{tabular}
\end{small}
\end{table}}
%A command that declares the end of the class feature table.
