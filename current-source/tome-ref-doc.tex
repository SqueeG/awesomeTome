...
\newcommand{\racedescription}[1]{\newline\indent\ability{Physical Description}{#1}}
\newcommand{\racepersonality}[1]{\newline\indent\ability{Personality}{#1}}
\newcommand{\racesociety}[1]{\newline\indent\ability{Society}{#1}}
\newcommand{\racealignment}[1]{\newline\indent\ability{Alignment}{#1}}

\newcommand{\type}[1]{\ability{Type}{#1}\\}
\newcommand{\size}[1]{\ability{Size}{#1}\\}
\newcommand{\speed}[1]{\ability{Speed}{#1 speed}\\}
...
\noindent
\begin{tabu} to \columnwidth {X}
\header\textbf{\race ~Starting Age} \\
\end{tabu}
\rowcolors{1}{colortwo}{colorone}
...
\noindent
\begin{tabu} to \columnwidth {X}
\header\textbf{\race ~Height and Weight} \\
\end{tabu}
\rowcolors{1}{colortwo}{colorone}
