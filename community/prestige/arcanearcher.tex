...
\textit{Superior Seeking:} A superior seeking arrow flies unerringly to its target, even going around corners, but the arcane archer must know that an enemy is in a square; the arrow negates any miss chances from concealment or cover.  Her attack is rolled as normal.
