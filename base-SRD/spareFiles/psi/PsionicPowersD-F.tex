...
\hline
% ROW 1
\multicolumn{5}{|p{4.181in}|}{\begin{minipage}[t]{4.181in}\raggedright
\textbf{Detect Psionics}\end{minipage}}\\
\hline
% ROW 2
\multicolumn{5}{p{0.319in}|}{\begin{minipage}[t]{0.319in}\raggedright
\end{minipage}} & \multicolumn{1}{|p{1.141in}|}{\begin{minipage}[t]{1.141in}\centering
------------------\textbf{ Aura Strength ------------------}\end{minipage}}\\
\hline
% ROW 3
\multicolumn{4}{p{3.040in}|}{\begin{minipage}[t]{3.040in}\centering
\textbf{Power or Item }\end{minipage}} & \multicolumn{1}{p{0.064in}|}{\begin{minipage}[t]{0.064in}\centering
\textbf{Faint}\end{minipage}} & \multicolumn{4}{p{0.255in}|}{\begin{minipage}[t]{0.255in}\raggedright
\textbf{Moderate}\end{minipage}} & \multicolumn{1}{|p{1.141in}|}{\begin{minipage}[t]{1.141in}\raggedright
\textbf{Strong}\end{minipage}} & \multicolumn{1}{p{0.769in}|}{\begin{minipage}[t]{0.769in}\raggedright
\textbf{Overwhelming}\end{minipage}}\\
\hline
% ROW 4
\multicolumn{1}{p{0.669in}|}{\begin{minipage}[t]{0.669in}\centering
Functioning power \linebreak
(power level)\end{minipage}} & \multicolumn{1}{p{0.656in}|}{\begin{minipage}[t]{0.656in}\centering
3rd or lower\end{minipage}} & \multicolumn{1}{p{0.946in}|}{\begin{minipage}[t]{0.946in}\raggedright
4th-6th\end{minipage}} & \multicolumn{1}{p{0.064in}|}{\begin{minipage}[t]{0.064in}\raggedright
7th-9th\end{minipage}} & \multicolumn{1}{p{0.064in}|}{\begin{minipage}[t]{0.064in}\raggedright
10th+\linebreak
(deity-level)\end{minipage}}\\
\hline
% ROW 5
\multicolumn{1}{p{0.064in}|}{\begin{minipage}[t]{0.064in}\centering
Psionic item \linebreak
(manifester level)\end{minipage}} & \multicolumn{1}{p{0.064in}|}{\begin{minipage}[t]{0.064in}\centering
5th or lower\end{minipage}} & \multicolumn{1}{p{0.064in}|}{\begin{minipage}[t]{0.064in}\raggedright
6th-11th\end{minipage}} & \multicolumn{1}{|p{1.141in}|}{\begin{minipage}[t]{1.141in}\raggedright
12th-20th\end{minipage}} & \multicolumn{1}{p{0.769in}|}{\begin{minipage}[t]{0.769in}\raggedright
21st+\linebreak
(artifact)\end{minipage}}\\
\hline
\end{longtable}
...
\textbf{Original Strength}\end{minipage}} & \multicolumn{1}{p{1.111in}|}{\begin{minipage}[t]{1.111in}\raggedright
...
% ROW 3
\multicolumn{1}{|p{1.203in}|}{\begin{minipage}[t]{1.203in}\raggedright
Moderate\end{minipage}} & \multicolumn{1}{p{1.111in}|}{\begin{minipage}[t]{1.111in}\raggedright
1d6 x 10 minutes\end{minipage}}\\
\hline
% ROW 4
\multicolumn{1}{p{0.069in}|}{\begin{minipage}[t]{0.069in}\raggedright
Strong\end{minipage}} & \multicolumn{1}{p{0.069in}|}{\begin{minipage}[t]{0.069in}\raggedright
1d6 hours\end{minipage}}\\
\hline
% ROW 5
\multicolumn{1}{|p{1.203in}|}{\begin{minipage}[t]{1.203in}\raggedright
Overwhelming\end{minipage}} & \multicolumn{3}{p{1.250in}|}{\begin{minipage}[t]{1.250in}\raggedright
