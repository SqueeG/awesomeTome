%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Races}\label{chapter:Races}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Favored Class}\index{Favored Class}
%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Small Characters}\index{Small Characters}
%%%%%%%%%%%%%%%%%%%%%%%%%
...
Stonecunning: This ability grants a dwarf a +2 racial bonus on \linkskill{Search} checks to 
...
+2 racial bonus on \linkskill{Appraise} checks that are related to stone or metal items.

+2 racial bonus on \linkskill{Craft} checks that are related to stone or metal.

Automatic Languages: Common and Dwarven. Bonus Languages: Giant, Gnome, Goblin, 
Orc, Terran, and Undercommon.

Favored Class: \linkclass{Fighter}. A multiclass dwarf 's fighter class does not count when 
...
+2 racial bonus on \linkskill{Listen}, \linkskill{Search}, and \linkskill{Spot} checks. An elf who merely passes within 
...
Favored Class: \linkclass{Wizard}. A multiclass elf 's wizard class does not count when determining 
...
+2 racial bonus on \linkskill{Listen} checks.

+2 racial bonus on \linkskill{Craft} (alchemy) checks.
...
Favored Class: \linkclass{Bard}. A multiclass gnome's bard class does not count when determining 
...
+1 racial bonus on \linkskill{Listen}, \linkskill{Search}, and \linkskill{Spot} checks.

+2 racial bonus on \linkskill{Diplomacy} and \linkskill{Gather Information} checks.
...
Favored Class: \linkclass{Barbarian}. A multiclass half-orc's barbarian class does not count 
...
+2 racial bonus on \linkskill{Climb}, \linkskill{Jump}, and \linkskill{Move Silently} checks.
...
Favored Class: \linkclass{Rogue}. A multiclass halfling's rogue class does not count when determining 
whether she takes an experience point penalty for multiclassing.
