...
\section{Classes}
%\input{community/classes/pending/curator}
\input{community/classes/kantianpaladin}
%\input{community/classes/pending/masterofwrath}
%\input{community/classes/pending/ranger}
\input{community/classes/shadowwarrior}
\input{community/classes/sohei}
\input{community/classes/spherelock}
%\input{community/classes/pending/thaumaturge}

\section{Prestige Classes}
\input{community/prestige/arcanearcher}
\input{community/prestige/arcanestrategist}
%\input{community/prestige/pending/berzerker}
\input{community/prestige/bignob}
%\input{community/prestige/pending/bladefighter}
\input{community/prestige/bladesinger}
\input{community/prestige/crusaderelemental}
\input{community/prestige/defenderofwoods}
\input{community/prestige/disciplespiritwave}
\input{community/prestige/dragondisciple}
\input{community/prestige/drunkenmaster}
\input{community/prestige/eldritchknight}
\input{community/prestige/enlighteneddisciple}
\input{community/prestige/gentlemonk}
\input{community/prestige/golemknight}
\input{community/prestige/holycrusader}
%\input{community/prestige/pending/invisibleblade}
\input{community/prestige/lunarknight}
\input{community/prestige/maelstrom}
\input{community/prestige/meteorninja}
\input{community/prestige/ogremage}
\input{community/prestige/tigermonk}
\section{Feats}
