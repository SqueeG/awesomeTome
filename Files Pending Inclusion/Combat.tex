...
\ability{Natural Attacks:}{During a full attack a creature may attack once with each natural weapon it has.  Primary natural weapons take no penalty to hit or damage (1 times strength modifier, or 1 \textonehalf times strength modifier if it is the creatures only natural attack), but secondary natural weapons take a \textendash5 penalty to hit and only deal \textonehalf strength modifier damage on a successful hit.}
